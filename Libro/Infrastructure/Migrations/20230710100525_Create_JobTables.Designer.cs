...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230710100525_Create_JobTables")]
            ...
            modelBuilder.Entity("Domain.Entities.BookReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BookReservationId = 1,
                            BookId = 1,
                            ReserveDate = new DateTime(2023, 7, 10, 0, 0, 0, 0, DateTimeKind.Local),
                            UserId = 4
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.BookReservationJob", b =>
                {
                    ...
                    b.HasKey("BookReservationJobId");

                    b.HasIndex("BookReservationId");

                    b.ToTable("BookReservationJobs");
                });
